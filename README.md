...
- Un cron est sur le conteneur du Postgres. il fait un dump toutes les heures dans le dossier Postgres/SaveDb. Pour le modifier, c'est dans le dossier Postgres. Pensez à rebuild l'image docker !
